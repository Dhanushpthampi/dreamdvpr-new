...
import { VStack, Divider, Box, HStack, Text, IconButton, FormControl, FormLabel, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, Input } from '@chakra-ui/react';
                ...
                <HStack>
                  <FormControl>
                    ...
                    <NumberInput
                      ...
                      min={1}
                      max={3}
                      onChange={(valueString) => handleUpdateService(index, 'colSpan', parseInt(valueString) || 1)}
                    >
                      <NumberInputField />
                      <NumberInputStepper>
                  ...
                  <FormControl>
                    ...
                    <NumberInput
                      ...
                      min={1}
                      max={3}
                      onChange={(valueString) => handleUpdateService(index, 'rowSpan', parseInt(valueString) || 1)}
                    >
                      <NumberInputField />
                      <NumberInputStepper>
                        <NumberIncrementStepper />
