...
const ServiceCard = ({ title, description, icon, colSpan = 1, rowSpan = 1, iconColor }) => {
    return (
        <MotionGridItem
            ...
            transition="all 0.3s"
            whileHover={{ boxShadow: "0 0 30px rgba(0, 171, 173, 0.2), 0 8px 32px rgba(0, 0, 0, 0.1)" }}
            display="flex"
...
const ServicesGrid = () => {
    return (
        <Box py={24} bg="gray.50" id="services" position="relative" overflow="hidden">
            <ParticleBackground />
            <Container maxW="container.xl">
                <Box textAlign="center" mb={16} maxW="2xl" mx="auto">
                    <Heading size="2xl" mb={4} color="text.main">Our Expertise</Heading>
