...
const AdminSidebar = ({ isMobile = false, onClose }) => {
  ...
  const menuItems = [
    ...
    { label: 'Generate Invoice', path: '/admin/invoices', icon: 'M14 2H6c-1.1 0-1.99.9-1.99 2z' },
    { label: 'Generate Proposal', path: '/admin/proposals', icon: 'M19 3h-4.18C14.4 1.84 13.3 1 12 1z' },
    { label: 'Generate NDA', path: '/admin/nda', icon: 'M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z' },
    { label: 'Generate Contract', path: '/admin/contracts', icon: 'M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z' },
  ];
